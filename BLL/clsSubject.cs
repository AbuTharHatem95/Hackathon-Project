...
namespace BLL
{
    public class clsSubject : absBaseEntity
    {
        ...
        public static DataTable GetAll() => clsSubjectData.GetAll();

        public static DataTable GetAllSubjectsByStage(int stageId) => clsSubjectData.GetSubjectsByStageAndClass(stageId);
