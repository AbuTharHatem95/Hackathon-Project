...
namespace BLL
{
    public class clsQuestionsType: absBaseEntity
    {
        ...
        public async Task<DataTable?> GetAllQuestionTypesByClassAndStageAndSubjectAsync(int stclass, int stageId, int subjectId) 
            => await clsQuestionsTypeData.GetAllQuestionTypesBySubjectAndClassAndStageAsync(stclass, stageId, subjectId);
        ...
        public static DataTable GetAllQuestionTypesByClassAndStageAndSubject( int subjectId)
            => clsQuestionsTypeData.GetAllQuestionTypesBySubjectAndClassAndStage(subjectId);
